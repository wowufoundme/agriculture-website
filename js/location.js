...
function getPendingData(page = 1) {
    ...
    if (page !== 1)
        url = `http://18.224.202.135/api/locations/pending?page=${page}`
    else
...
function getOngoingData(page = 1) {
    ...
    if (page !== 1)
        url = `http://18.224.202.135/api/locations/ongoing?page=${page}`
    else
...
function getCompletedData(page = 1) {
    ...
    if (page !== 1)
        url = `http://18.224.202.135/api/locations/completed?page=${page}`
    else
        url = `http://18.224.202.135/api/locations/completed`
    $.ajax({
        url: url,
        type: 'GET',
        headers: {
